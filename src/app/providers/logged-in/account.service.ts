...
export class AccountService {
  ...
  profile(): Observable<any> {
    const url = this._accountEndpoint + '/profile?expand=isWorking,bank,area,isProfileCompleted,nationality,country,university,candidateSkills,candidateExperiences';

...
@Component({
  selector: 'app-kuwaiti-national',
  templateUrl: './kuwaiti-national.page.html',
  styleUrls: ['./kuwaiti-national.page.scss'],
})
export class KuwaitiNationalPage implements OnInit {
